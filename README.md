...
The project is intended for heterogeneous GPU clusters, distributed AI training, inference services, coupled AI/HPC workflows, and fault-injection experiments. It provides a conceptual architecture, resilience metrics, and an evaluation methodology to measure detection time, blast radius, functional continuity, safe recovery time, post-recovery correctness, and operational overhead.
